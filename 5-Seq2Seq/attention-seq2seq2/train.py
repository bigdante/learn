...
if __name__ == '__main__':
    ...
    # 输入一些句子测试下
    evaluateAndShowAttention("d(8exp^(9e))/de")
    print("answer:72exp^(9e)")
    evaluateAndShowAttention("d(20exp^(17m)+18exp^(m))/dm")
    print("answer:340exp^(17m)+18exp^(m)")
    evaluateAndShowAttention("d(12exp^(12t)+9exp^(20t))/dt")
    print("answer:144exp^(12t)+180exp^(20t)")
