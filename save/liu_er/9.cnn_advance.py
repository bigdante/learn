...
train_dataset = datasets.MNIST(root='../dataset_dataloader_transform/mnist/', train=True, download=True, transform=transform)
train_loader = DataLoader(train_dataset, shuffle=True, batch_size=batch_size)
test_dataset = datasets.MNIST(root='../dataset_dataloader_transform/mnist/', train=False, download=True, transform=transform)
